...
class StudiosViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "StudioCell")
        ...
        URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            do {
                if let json = try JSONSerialization.jsonObject(with: data) as? [String: Any],
                   ...
                   let findStudios = dataDict["findStudios"] as? [String: Any],
                   let studiosArray = findStudios["studios"] as? [[String: Any]] {
                    
                    DispatchQueue.main.async {
                        self.studios = studiosArray
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let count = studio["scene_count"] as? Int ?? 0
