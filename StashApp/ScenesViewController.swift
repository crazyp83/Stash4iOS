...
class ScenesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let title = scene["title"] as? String ?? "Untitled"
        let studio = (scene["studio"] as? [String: Any])?["name"] as? String ?? ""
        
        cell.textLabel?.text = title
        cell.detailTextLabel?.text = studio
        return cell
    }
}